...
interface Appliance extends Omit<ApiAppliance, 'weekday_hours' | 'weekend_hours'> {
...
export default function Page() {
 ...
 const fetchData = useCallback(async () => {
   try {
     ...
     const transformedAppliances = appliancesData.appliances.map((appliance: ApiAppliance) => ({
       ...appliance,
